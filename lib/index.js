...
const mergeParams = (videoInfo, params, filePath, customTitle) => ({
  title: customTitle ?? params.title ?? videoInfo.videoDetails.title,
...
const youtubeMp3Converter = (filePath) => (youtubeUrl, customTitle, params={}) =>
  ytdl
      .getInfo(youtubeUrl)
      .then((info) => mergeParams(info, params, filePath, customTitle))
